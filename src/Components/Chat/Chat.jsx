...
export default function Chat() {
    ...
    return (
        <>
            <div className='w-[77%] ms-[20%] bg-fixed bg-contain pe-2 ' style={{ backgroundImage: `url(${bgWhatsApp})` }}>
                <div className='fixed top-0 md:left-[20%] md:right-[3%]'>
                    <div className='p-2 flex items-center justify-between bg-[#2B3941]'>
                        <div className='personalPhoto flex items-center'>
                            <img src={me} alt="personal photo" className='w-8 h-8 rounded-full' />
                            <div className='ms-2'>
                                <p className='text-white'>{massageChat[0]?.conversation.name}</p>
                ...
                <div className='my-16 pb-5 ms-2'>
                    {massageChat.map((message, index) => (
                        ...
                        >
                            <div>
                                <p className='me-8 break-words overflow-wrap-anywhere'>{message.message}</p>
